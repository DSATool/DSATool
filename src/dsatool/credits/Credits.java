...
public class Credits {
	...
	static {
		...
		credits.add(new Credits("Cinzel\nCopyright 2020 The Cinzel Project Authors", "SIL Open Font License 1.1",
				Util.getAppDir() + "/licenses/Cinzel-OFL.txt", "https://github.com/NDISCOVER/Cinzel", null));
		credits.add(new Credits("Crimson Pro\nCopyright 2018 The Crimson Pro Project Authors", "SIL Open Font License 1.1",
				Util.getAppDir() + "/licenses/Crimson-OFL.txt", "https://github.com/Fonthausen/CrimsonPro", null));
